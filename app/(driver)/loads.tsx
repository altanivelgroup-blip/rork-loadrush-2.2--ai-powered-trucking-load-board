...
export default function DriverLoads() {
  ...
  const filteredLoads = useMemo(() => {
    ...
    if (selectedSort === 'Highest $/mi') {
      ...
      filtered.sort((a, b) => a.cargo.weight - b.cargo.weight);
    }
          ...
          filteredLoads.map((load) => (
            ...
            >
              ...
              <View style={styles.cardBody}>
                <Text style={styles.statusLabel}>Status: Pending</Text>
                <Text style={styles.rateText}>Rate: ${load.rate.toLocaleString()}</Text>
                <Text style={styles.routeText}>
                  Route: {load.pickup.city}, {load.pickup.state} → {load.dropoff.city}, {load.dropoff.state}
                </Text>
                <Text style={styles.bidsText}>Bids: 2</Text>
