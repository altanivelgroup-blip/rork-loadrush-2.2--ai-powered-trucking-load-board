'use strict';
// scripts/seed-loads-30d.js
// Node.js-compatible Firestore seeder for test loads with 30-day persistence
// No React Native / Expo imports. Tested on Node 18+.

/* eslint-disable no-console */

const { initializeApp } = require('firebase/app');
const { getFirestore, doc, setDoc, Timestamp, serverTimestamp } = require('firebase/firestore');
...
function generateLoads(count, ttlDays, prefix, startNum) {
  const loads = [];
